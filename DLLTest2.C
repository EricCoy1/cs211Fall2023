...
int main()
{
  ...
  */
  ...
  l3.addInOrderDescend(5);
  l3.displayAll(); //[5]
  cout << endl;  
  l3.printAllReverseDLL(); //5
  cout << endl;

  cout << "------------ B -------------" << endl;

  l3.addInOrderDescend(1);
  l3.displayAll(); //[5] -> [1]
  cout << endl; 
  l3.printAllReverseDLL(); // 1 5
  cout << endl;

  cout << "------------ C -------------" << endl;

  l3.addInOrderDescend(3);
  l3.displayAll(); //[5] -> [3] -> [1] 
  cout << endl; 
  l3.printAllReverseDLL();  // 1 3 5 
  cout << endl;

  cout << "------------ D -------------" << endl;

  l3.addInOrderDescend(0);
  l3.displayAll(); //[5] -> [3] -> [1] -> [0]
  cout << endl; 
  l3.printAllReverseDLL(); // 0 1 3 5
  cout << endl;

  cout << "------------ E -------------" << endl;

  l3.addInOrderDescend(7);
  l3.displayAll(); //[7] -> [5] -> [3] -> [1] -> [0]
  cout << endl; 
  l3.printAllReverseDLL(); // 0 1 3 5 7 
  cout << endl;

  cout << "------------ F -------------" << endl;

  l3.addInOrderDescend(7);
  l3.displayAll(); //[7] -> [7] -> [5] -> [3] -> [1] -> [0]
  cout << endl; 
  l3.printAllReverseDLL(); // 0 1 3 5 7 7
  cout << endl;

  cout << "------------ G -------------" << endl;

  l3.addInOrderDescend(5);
  l3.displayAll(); //[7] -> [7] -> [5] -> [5] -> [3] -> [1] -> [0]
  cout << endl; 
  l3.printAllReverseDLL(); // 0 1 3 5 5 7 7
  cout << endl;

  cout << "------------ H -------------" << endl;

  l3.addInOrderDescend(0);
  l3.displayAll(); //[7] -> [7] -> [5] -> [5] -> [3] -> [1] -> [0] -> [0] 
  cout << endl; 
  l3.printAllReverseDLL(); // 0 0 1 3 5 5 7 7
  cout << endl;
  */
